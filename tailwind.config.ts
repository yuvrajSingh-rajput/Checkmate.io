  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        move: {
          brilliant: "hsl(var(--move-brilliant))",
          best: "hsl(var(--move-best))",
          good: "hsl(var(--move-good))",
          inaccuracy: "hsl(var(--move-inaccuracy))",
          mistake: "hsl(var(--move-mistake))",
          blunder: "hsl(var(--move-blunder))",
        },
        eval: {
          white: "hsl(var(--eval-white))",
          black: "hsl(var(--eval-black))",
          advantage: "hsl(var(--eval-advantage))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
